...
import roofing from '../../assets/Service Images/roofing.jpg'
import siding from '../../assets/Service Images/siding.png'
import renovation from '../../assets/Service Images/renovation.png'
const process = () => {
    return (
        <div className={classes.Process}>
            <div className={classes.Text}>
                ...
                <ServiceChunk reverse={true} src={roofing}>
                    <h2>Roofing</h2>
